namespace ROOT.CIMV2.Win32 {
    ...
    public class OperatingSystem0 : System.ComponentModel.Component {
        ...
        public OperatingSystem0(string keyName) {
            this.InitializeObject(null, new System.Management.ManagementPath(OperatingSystem0.ConstructPath(keyName)), null);
        }
        
        public OperatingSystem0(System.Management.ManagementScope mgmtScope, string keyName) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(OperatingSystem0.ConstructPath(keyName)), null);
        }
        
        public OperatingSystem0(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public OperatingSystem0(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
...
31 - NT Server")]
        ...
        public SuiteMaskValues SuiteMask {
            get {
                if ((curObj["SuiteMask"] == null)) {
                    return ((SuiteMaskValues)(System.Convert.ToInt32(62)));
                }
        ...
        public class OperatingSystem0Collection : object, ICollection {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new OperatingSystem0(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            ...
            public class OperatingSystem0Enumerator : object, System.Collections.IEnumerator {
                ...
                public virtual object Current {
                    get {
                        return new OperatingSystem0(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
